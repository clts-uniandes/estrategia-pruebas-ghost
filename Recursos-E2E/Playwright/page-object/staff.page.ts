...
export default class StaffPage {
    ...
    public get eleErrorMessageDiv() {
        const errorMessageDiv = this.page.locator("//article/div[text()='Error sending email! Error sending email: Failed to send email. Reason: getaddrinfo ENOTFOUND errdomain. Please check your email settings and resend the invitation.']");
