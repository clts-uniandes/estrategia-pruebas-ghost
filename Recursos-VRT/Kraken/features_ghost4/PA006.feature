Feature: Login- Crear pagina - Asigna pagina un navbar - verificar que se pueda acceder al navber - Editar titulo pagina - Editar enlace asociado a navbar utilizando el mismo titulo editado - verificar que se muestre "PAGE NOT FOUND"

    @user1 @web

    Scenario: Login
        Given I navigate to page "<LOGIN_URL>"
        And I take a screenshot on "PA006"
        ...
        And I take a screenshot on "PA006"
        And I click on Navigation in the navbar
        And I enter "Test Nav Editar" nav label
        And I take a screenshot on "PA006"
        And I enter "http://localhost:2368/test-nav-editar" nav url
        And I take a screenshot on "PA006"
        ...
        And I wait for 2 seconds
        When I navigate to page "http://localhost:2368/test-nav-editar"
        And I take a screenshot on "PA006"
        Then I should see text "Test Nav Editar"
        And I should see text "Descripcion de la pagina Test Nav Editar"
        And I wait for 2 seconds
        When I navigate to page "http://localhost:2368/ghost/#/dashboard"
        And I take a screenshot on "PA006"
