...
test.describe("PDARX06 - Actualizacion perfil de usuario, todos los valores bajo el límite pero enviar update con nombre vacío, \
no se puede cambiar nombre, pero post author encaja con nombre perfil actual", () => {
    ...
    test("A: A-priori (pool), R: robustez, vacio/string 0", async () => {
