...
test.describe("PDPRX14 - Actualizacion perfil de usuario, todos los valores bajo el límite pero email con no-ascii/Unicode, \
    ...
    test.beforeAll( async() => {
        ...
        randomTrialEmail = "田中さんにあげて下さい"+formDataList[selected].get(ProfileFields.E_MAIL);
