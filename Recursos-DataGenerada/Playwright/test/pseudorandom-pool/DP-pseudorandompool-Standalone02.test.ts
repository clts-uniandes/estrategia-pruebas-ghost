...
test.describe("PDPRX12 - Actualizacion perfil de usuario, todos los valores bajo el límite pero enviar un slug vacio (ISSUE: deja guardar slug vacio), \
    ...
    test("P: Pseudorandom (pool) dynamic, R: robustez, vacio/string 0", async () => {
