...
test.describe("PDPFL13 - Actualizacion perfil de usuario, todos los valores bajo el límite, \
        nuevo post author, el mail es el nuevo de perfil", () => {
    ...
    test("P: Pseudorandom (pool) dynamic, F: frontera,  L: por debajo, Low", async () => {
        ...
        expect(currentEmail).toContain(randomEmail);
        await new Promise(r => setTimeout(r, 2000));
    });
