...
let selected = 0;
let randomTrialSlug: string;

test.describe("PDPFH11 - Actualizacion perfil de usuario, todos los valores bajo el límite pero slug arriba del limite (ISSUE: logra ingresar y salva), \
    ...
    test.beforeAll( async() => {
        ...
        randomTrialSlug = randomElement.useFaker(FakerCategories.CHARS, 195);
    ...
    test("P: Pseudorandom (pool) dynamic, F: Arriba la frontera, High", async () => {
        console.log("The generated pool drawn full name is: " + randomFullName);
        console.log("The generated pool drawn slug is: " + randomTrialSlug);
        ...
        await staffEditorPage.refillSlug(randomTrialSlug);
        ...
        expect(staffEditorPage.eleRetryButtonWait.textContent()).toBeTruthy();
        ...
        //Then the new slug doesn't work
