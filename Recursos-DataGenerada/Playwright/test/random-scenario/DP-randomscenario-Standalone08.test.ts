...
test.describe("PDRRX28 - Actualizacion perfil de usuario, todos los valores bajo el límite pero bio alfanumérico, \
    ...
    test.beforeAll( async() => {
        ...
        randomTrialBio = randomElement.useFaker(FakerCategories.ALPHANUMERIC, 120);
    });
