...
test.describe("PDRRX30 - Actualizacion perfil de usuario, todos los valores bajo el límite pero enviar update con bio vacía, \
    ...
    test("R: Random scenario, R: robustez, vacio/string 0", async () => {
